...
const renderContent = {
    ...
    2:(
        <InfoBox 
            text="I only worked for a few firms, but I learned a lot along the road."
            link="/about"
            btnText="Learn More"
        />
    ),
    3:(
        <InfoBox 
            text="I built multiple projects to show off my skills. Are you curious to know more?"
            link="/projects"
